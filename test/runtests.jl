...
# definition & adding
@traitdef Tr1{X}
@test trait(Tr1{Int}) == NotTrait{Tr1{Int}}
@test !istrait(Tr1{Int})
@traitimpl Tr1{Integer}
@test trait(Tr1{Int}) == Tr1{Int}
@test istrait(Tr1{Int})
@test trait(Tr1{Bool}) == Tr1{Bool}
@test trait(Tr1{AbstractString}) == NotTrait{Tr1{AbstractString}}
@test !istrait(Tr1{AbstractString})

# Logic.  trait(Tr) returns the same trait Tr if it is fulfilled and
# NotTrait{Tr} otherwise.  This is a bit confusing.
@test trait(Tr1{AbstractString}) == NotTrait{Tr1{AbstractString}}
@test istrait(Tr1{AbstractString}) == false
@test trait(NotTrait{Tr1{AbstractString}}) == NotTrait{Tr1{AbstractString}}
@test istrait(NotTrait{Tr1{AbstractString}}) == true
@test trait(NotTrait{NotTrait{Tr1{AbstractString}}}) == NotTrait{Tr1{AbstractString}}
@test istrait(NotTrait{NotTrait{Tr1{AbstractString}}}) == false
@test trait(NotTrait{NotTrait{NotTrait{Tr1{AbstractString}}}}) == NotTrait{Tr1{AbstractString}}
@test istrait(NotTrait{NotTrait{NotTrait{Tr1{AbstractString}}}}) == true

@test trait(NotTrait{Tr1{Integer}}) == Tr1{Integer}
@test istrait(NotTrait{Tr1{Integer}}) == false
@test trait(NotTrait{NotTrait{Tr1{Integer}}}) == Tr1{Integer}
@test istrait(NotTrait{NotTrait{Tr1{Integer}}}) == true
@test trait(NotTrait{NotTrait{NotTrait{Tr1{Integer}}}}) == Tr1{Integer}
@test istrait(NotTrait{NotTrait{NotTrait{Tr1{Integer}}}}) == false


@traitdef Tr2{X,Y}
@test trait(Tr2{Int,AbstractFloat}) == NotTrait{Tr2{Int,AbstractFloat}}
@traitimpl Tr2{Integer,Float64}
@test trait(Tr2{Int,Float64}) == Tr2{Int,Float64}
@test trait(Tr2{Int,Float32}) == NotTrait{Tr2{Int,Float32}}
...
@traitdef TrArrow2{X}
@traitimpl NotTrait{TrArrow2{X}} < -isarrow(X)
